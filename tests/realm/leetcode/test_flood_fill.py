...
from challenges.realm.leetcode.flood_fill import Solution
...
class FloodFillTests(unittest.TestCase):
    ...
    def test_should_find_combination_sum(self, image, sr, sc, new_color, flooded_img):
        # act
        image = self.solution.floodFill(image, sr, sc, new_color)
